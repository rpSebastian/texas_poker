...
if __name__=="__main__":
    ...
    num = 50
    for i in range(num):
        client = Client('TestRandomAll', 'lbr-fc-1-4')
        client.start()
    for i in range(num):
        client = Client('TestRandomAll', 'lbr-fc-3-4')
        client.start()
    for i in range(num):
        client = Client('TestRandomAll', 'lbr-fcpa-1-4')
        client.start()
    for i in range(num):
        client = Client('TestRandomAll', 'lbr-fcpa-3-4')
        client.start()
