# CM  总是check/call
# The Calling Machine stays in the game for a showdown regardless of hand strength.
# To effectively exploit its weakness, players must refrain from bluffing and raise
# aggressively when holding strong hands.
