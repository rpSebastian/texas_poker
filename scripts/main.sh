...
nohup python init/init_listener.py >> $CURPATH/nohup.out 2>&1 &
nohup python init/init_room_manager.py >> $CURPATH/nohup.out 2>&1 &
nohup python init/init_scheduler.py >> $CURPATH/nohup.out 2>&1 &
